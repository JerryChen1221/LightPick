...
```bash
wrangler d1 migrations apply lightpick-d1 --local  # For local dev
wrangler d1 migrations apply lightpick-d1           # For production
```
...
```python
# apps/api/src/lightpick/tools/sync_server_client.py
from lightpick.tools.sync_server_client import submit_kling_video_task
