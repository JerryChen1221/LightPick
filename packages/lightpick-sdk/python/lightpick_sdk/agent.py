"""
LightPickAgent — connects to ProjectRoom via WebSocket and executes custom actions.
...
logger = logging.getLogger("lightpick_sdk")
...
class LightPickAgent:
    """
    Connects to a LightPick ProjectRoom and executes registered custom actions.
    """
