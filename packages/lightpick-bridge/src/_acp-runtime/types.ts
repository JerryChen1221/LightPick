 ...
 * (`AcpRuntime`) works whether the agent is a local subprocess (lightpick-bridge
 ...
 *
 * Host examples:
 *   - Node spawner (lightpick-bridge, local CLIs, dev tools)
...
export interface AcpSession {
   ...
   * agent issued `tools/request` and the host (= lightpick CLI, openma
