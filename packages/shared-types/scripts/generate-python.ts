...
const PYTHON_OUTPUT_DIR = path.join(__dirname, '../python/lightpick_types');
...
const generatedPy = `"""
Auto-generated type definitions from @lightpick/shared-types

DO NOT EDIT MANUALLY - Run 'pnpm --filter @lightpick/shared-types generate:python' to regenerate.
"""
...
// Create __init__.py
const initPy = `"""
LightPick Types - Auto-generated from @lightpick/shared-types Zod schemas.

Usage:
    from lightpick_types import CanvasNode, CanvasEdge
"""

from lightpick_types.types import (
    NodeStatus,
    ActionType,
    Position,
    NodeData,
