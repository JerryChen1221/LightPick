...
export const MODEL_CARDS: ModelCard[] = [
  ...
  // ─── Video: JoyBuilder Kling-V3 Omni ────────────────────────
  {
    id: 'joybuilder-kling-v3-omni',
    name: 'JoyBuilder Kling-V3 Omni',
    provider: 'JoyBuilder',
    kind: 'video',
    defaultAspectRatio: '16:9',
    description: 'JoyBuilder Kling-V3 Omni — text/image/video/subject guided video generation and editing.',
    parameters: [
      {
        id: 'duration',
        label: 'Duration',
      ...
      },
      {
        ...
        type: 'boolean',
        defaultValue: false,
        description: 'For video editing, keep source video audio when supported.',
      },
      {
        id: 'video_role',
        label: 'Video role',
        type: 'select',
        options: [
          { label: 'Edit/Input video', value: 'input_video' },
          { label: 'Reference video', value: 'reference_video' },
        ],
        defaultValue: 'input_video',
        description: 'Use reference video for style/camera reference; use input video for direct edits.',
      },
      {
        id: 'subject_ids',
        label: 'Subject IDs',
        type: 'text',
        placeholder: '864895146134495263',
        defaultValue: '',
        description: 'Comma or newline separated subject IDs. Use <<<element_1>>> in the prompt.',
      },
      {
        ...
        defaultValue: '',
        description: 'Optional comma or newline separated public image URLs.',
      },
      {
        ...
        defaultValue: '',
        description: 'Optional comma or newline separated public video URLs.',
      },
    ],
    defaultParams: {
      duration: 7,
    ...
    input: {
      requiresPrompt: true,
      inputMode: { images: { max: 9 }, videos: { max: 3 } },
