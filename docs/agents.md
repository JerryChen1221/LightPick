...
This document provides a comprehensive overview of the task system and agent architecture in the LightPick project. The system is designed as a multi-layered architecture that handles AIGC (AI-Generated Content) tasks through atomic execution units, multi-agent workflows, and real-time synchronization.
...
**Location**: [apps/api/src/lightpick/workflow/](../apps/api/src/lightpick/workflow/)
...
**Location**: [apps/api/src/lightpick/workflow/middleware.py](../apps/api/src/lightpick/workflow/middleware.py)
...
**Location**: [apps/api/src/lightpick/workflow/backends.py](../apps/api/src/lightpick/workflow/backends.py)
...
**Location**: [apps/api/src/lightpick/workflow/tools.py](../apps/api/src/lightpick/workflow/tools.py)
...
**Location**: [apps/api/src/lightpick/database/pg_schema.py](../apps/api/src/lightpick/database/pg_schema.py)
...
**Location**: [apps/api/src/lightpick/api/tasks_router.py](../apps/api/src/lightpick/api/tasks_router.py)
...
**Location**: [apps/api/src/lightpick/api/describe_router.py](../apps/api/src/lightpick/api/describe_router.py)
...
**Location**: [apps/api/src/lightpick/services/generation_models.py](../apps/api/src/lightpick/services/generation_models.py)
...
2. **Implement Generation Service** ([apps/api/src/lightpick/services/generation_models.py](../apps/api/src/lightpick/services/generation_models.py)):
   ```python
   async def generate_my_task(params: dict) -> dict:
       # Implement generation logic
   ```

3. **Add Task Router Handler** ([apps/api/src/lightpick/api/tasks_router.py](../apps/api/src/lightpick/api/tasks_router.py)):
   ```python
...
1. **Define Agent** ([apps/api/src/lightpick/workflow/agents/](../apps/api/src/lightpick/workflow/agents/)):
   ```python
   class MyAgent:
...
3. **Add Tools** ([apps/api/src/lightpick/workflow/tools.py](../apps/api/src/lightpick/workflow/tools.py)):
   ```python
   @tool
...
- **Task Router**: [apps/api/src/lightpick/api/tasks_router.py](../apps/api/src/lightpick/api/tasks_router.py)
- **Task Processor**: [apps/api/src/lightpick/services/task_processor.py](../apps/api/src/lightpick/services/task_processor.py)
- **Generation Service**: [apps/api/src/lightpick/services/generation_models.py](../apps/api/src/lightpick/services/generation_models.py)
- **Agent System**: [apps/api/src/lightpick/workflow/](../apps/api/src/lightpick/workflow/)
- **Database Schema**: [apps/api/src/lightpick/database/](../apps/api/src/lightpick/database/)
...
**Maintainer**: LightPick Development Team
